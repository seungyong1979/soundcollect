...
# SVG 일러스트 4종 (흰색 stroke) — 선암사와 동일 아이콘 재사용
...
# NFC SVG 아이콘 — WiFi/NFC 웨이브 아이콘 (골드)
nfc_svg = '''<svg viewBox="0 0 24 24" fill="#D4A24A" xmlns="http://www.w3.org/2000/svg" style="width:10pt;height:10pt;">
  <path d="M1 9l2 2c4.97-4.97 13.03-4.97 18 0l2-2C16.93 2.93 7.08 2.93 1 9zm8 8l3 3 3-3c-1.65-1.66-4.34-1.66-6 0zm-4-4l2 2c2.76-2.76 7.24-2.76 10 0l2-2C15.14 9.14 8.87 9.14 5 13z"/>
</svg>'''

NOTE4 = '순천만에서 직접 녹음한 음원입니다.<br/>갯벌의 소리풍경에 귀를 기울여 보세요.'
steps = [
    ...
    ("순천만의 자연 소리를 감상하세요", "Enjoy the natural soundscape of Suncheonman Bay", svg4, NOTE4),
]
...
.card{{position:absolute;width:105mm;height:148.5mm;
  background:#3D2408;overflow:hidden;}}
...
.dbar{{position:absolute;left:0;right:0;height:4pt;
  background:repeating-linear-gradient(90deg,
    #D4A24A 0,#D4A24A 5pt,
    #6B4520 5pt,#6B4520 10pt,
    #E3C9A0 10pt,#E3C9A0 15pt,
    #6B4520 15pt,#6B4520 20pt);
  opacity:.85;z-index:2;}}
.dbar.t{{top:0;}} .dbar.b{{bottom:0;}}

/* 배경 원형 */
.bgc{{position:absolute;border-radius:50%;background:#D4A24A;opacity:.05;}}
...
.bt-main{{font-family:'Bebas Neue',sans-serif;font-size:20pt;
  color:#F2E4CC;letter-spacing:.18em;line-height:1;}}
.bt-sub{{font-family:'Montserrat',sans-serif;font-size:4.5pt;font-weight:600;
  color:#ECC97A;letter-spacing:.26em;text-transform:uppercase;opacity:.9;}}
.bt-ko{{font-family:'Nanum Myeongjo',serif;font-size:5pt;
  color:#E3C9A0;letter-spacing:.18em;opacity:.72;}}
...
.sko{{font-family:'Noto Sans KR',sans-serif;font-size:9.5pt;font-weight:500;
  color:#F2E4CC;line-height:1.35;}}
.sen{{font-family:'Montserrat',sans-serif;font-size:6.5pt;
  color:#E3C9A0;opacity:.6;line-height:1.3;margin-top:1pt;}}
.step-note{{font-family:'Nanum Myeongjo',serif;font-size:5pt;
  color:#ECC97A;opacity:.8;line-height:1.5;margin-top:1.5pt;}}

/* 푸터 */
.cf{{flex-shrink:0;margin-top:4pt;padding-top:4pt;
  border-top:.4pt solid rgba(212,162,74,.28);
  display:flex;flex-direction:column;gap:3pt;}}

/* UNESCO/헤리티지 pill — border 단일, outline/box-shadow 없음 */
...
.copy{{font-family:'Montserrat',sans-serif;font-size:3pt;
  color:#E3C9A0;opacity:.32;letter-spacing:.04em;}}
</style>
</head>
<body>
...
out = '/home/user/webapp/suncheonman/nfc-guide-print.html'
