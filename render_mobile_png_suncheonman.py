...
GREEN_DEEP  = (61, 36, 8)
GREEN_MID   = (107, 69, 32)
GREEN_LIGHT = (156, 111, 53)
GOLD        = (212, 162, 74)
GOLD_LT     = (236, 201, 122)
BEIGE       = (242, 228, 204)
BEIGE_DIM   = (184, 147, 95)
WHITE       = (255, 255, 255)
# 베이지 배경 팔레트
BEIGE_BG    = (245, 236, 218)   # 카드 배경 (amber-warm cream)
BEIGE_CARD  = (240, 228, 208)   # 약간 더 진한 베이지
...
COVER_S = 196
cover = load_img("suncheonman/images/cd_cover.jpg", (COVER_S, COVER_S))
...
disc = load_img("suncheonman/images/cd_disc.png", (DISC_S, DISC_S))
...
draw.text((TX, 54), "SUNCHEONMAN", font=f_main, fill=GREEN_DEEP)
f_sub = fnt(FONT_KO_L, 22)
draw.text((TX, 148), "WETLAND  SOUNDSCAPE", font=f_sub, fill=(138, 107, 58))
f_ko_sm = fnt(FONT_MJ, 23)
draw.text((TX, 180), "순천만 사운드스케이프", font=f_ko_sm, fill=(90, 66, 48, 200))
...
steps = [
    ...
    ("순천만의 자연 소리를 감상하세요",   "Enjoy the natural soundscape of Suncheonman Bay",
     "순천만에서 직접 녹음한 음원입니다.\n갯벌의 소리풍경에 귀를 기울여 보세요."),
]
...
ub_text  = "★  KOREAN TIDAL FLATS · 2021  ★"
...
# ── 저장 ─────────────────────────────────────────────
out = "suncheonman/nfc-guide-mobile.png"
